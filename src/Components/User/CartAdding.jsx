...
//     <div className={`container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-4 md:py-6 lg:py-8 ${cardClass}`}>
...
//                     <h3 className={`text-lg sm:text-xl font-semibold text-black ${cardTitleClass}`}>{item.product.title}</h3>
...
//                       className={`bg-red-500 text-white py-1 px-2 rounded transition-transform transform hover:scale-105 ${buttonVariant}`}
//                     >
//                       <FaTrash />
//                     </button>
//                   </div>
...
//           className={`bg-gray-500 text-white py-2 px-4 rounded transition-transform transform hover:scale-105 ${buttonVariant}`}
//         >
//           Clear Cart
//         </button>
//         <button
